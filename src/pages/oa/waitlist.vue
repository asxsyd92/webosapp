...
import http from '../../utils/http';
	...
	const _feedsad=ref("");
	  ...
	  onLoad((event :any) => {
	uni.setStorageSync('token',"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiMSIsIm9yZ25hbWUiOiLotKLliqHpg6giLCJpcCI6IjM5LjEyOC4xNS4xOTMiLCJuYW1lIjoi5b6u5L-.A7x4zQolAv1IheOftc6bT-jyS9x7kWSexavlOtu5Xa4");
             init();
	 })
