	...
	<view>
		...
		<view style="   position: absolute; top: 25%;    width: 100%;">
			<view v-if="canIUse || canIGetUserProfile">
				<view class='content'>
					<image style="width: 140rpx; height: 140rpx;" mode="aspectFit"
						src="@/static/images/ic_launcher.png"></image>
		...
		<view>
			<view class="limiter">
				<view class="container-login100">
					<view class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
						<form class="login100-form validate-form">
							<span class="login100-form-title p-b-31">Webos</span>
							...
							<view class="flex-col-c p-t-25">
								<!--<a href="/api/downloadfile?url=工务段App.apk&type=.apk">下载安卓App</a>-->
							</view>
						</form>
					</view>
				</view>
...
export default {
	...
	setup() {
		...
		const updateUserInfo = () => {
			...
			type = "wx";
			//#endif   
			http.post("/api/applets/updateUserInfo", {
				openid: openid.value,
